...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <main class="col-md-9 col-lg-9 col-sm-8 col-xs-12 contato">
                ...
                <div class="row">
                   ...
                   <div class="col-md-4 col-lg-3 col-sm-6 col-xs-12 text-center">
                       <form action="mensagem.php" method="POST">
                          <fieldset>
                          <p class="text">Nome:</p>     <input type="text" name="cxnome" required="required" placeholder="ex. Paulo Mendes"><br> 
                          <p class="text">E-mail:</p>   <input type="email" name="cxemail" required="required" placeholder="ex. paulomendes@gmail.com"><br>
                          <p class="text">Mensagem:</p> <input type="text" id="cxmensagem" name="cxmensagem" required="required" placeholder="ex. Oi, tudo bem?"><br>
                ...
                <?php ?>
                  ...
                  <div class="col-md-4 col-lg-3 col-sm-6 col-xs-12 text-center">
                    ...
                    <img src="img/contato.png" alt="imagem do contato">
