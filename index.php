 ...
 <!-- INÍCIO DO MENU SUPERIOR -->
        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">
                    <img width="60px" height="60px" src="img/logo.png" alt="banner rotativo" class="img-responsive">
                </a>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <main class="col-md-9 col-lg-9 col-sm-8 col-xs-12 home">
                ...
                <center>
                    ...
                    <div class="container" align="justify">
                        ...
                        <p class="text">Bookshop B-raya, a melhor livraria que você vai encontrar! Sempre inovando e trazendo produtos novos e de qualidade. Quando pensar em um livro, pense na Bookshop B-raya!</p>
                    </div>
                </center>
            </main>
        </div>
